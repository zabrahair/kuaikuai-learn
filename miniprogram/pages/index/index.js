 ...
 */
  ...
  onClickSpellEnglishWords: function(e){
    wx.navigateTo({
      url: '/pages/gamesRoom/spellEnglishWords/spellEnglishWords?gameMode=' + gConst.GAME_MODE.NORMAL + '&tableValue=' + TABLES.MAP.ENGLISH_WORDS.value + '&tableName=' + TABLES.MAP.ENGLISH_WORDS.name
    })    
  },
 ...
 */
  onClickSpellEnglishWordsWrong: function (e) {
    wx.navigateTo({
      url: '/pages/gamesRoom/spellEnglishWords/spellEnglishWords?gameMode=' + gConst.GAME_MODE.WRONG + '&tableValue=' + TABLES.MAP.ENGLISH_WORDS.value + '&tableName=' + TABLES.MAP.ENGLISH_WORDS.name + "(错)",
    })
  },
  /**
   * 检索收藏的单词
  ...
  onClickSpellEnglishWordsFavorites: function(e){
    wx.navigateTo({
      url: '/pages/gamesRoom/spellEnglishWords/spellEnglishWords?gameMode=' + gConst.GAME_MODE.FAVORITES + '&filterTags=收藏' + '&tableValue=' + TABLES.MAP.ENGLISH_WORDS.value + '&tableName=' + TABLES.MAP.ENGLISH_WORDS.name + '收藏',
    })
  },
  /**
   * 语文知识学习
